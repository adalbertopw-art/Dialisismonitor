...
export function DigitalTwinSimulator({ currentSbp, currentUfr, riskScore }: any) {
  ...
  return (
    <Card className="bg-[#0a0a0a] border-indigo-500/20 shadow-[0_0_30px_rgba(99,102,241,0.05)] overflow-hidden">
      <CardHeader className="py-4 px-6 border-b border-white/5 bg-indigo-500/5 relative overflow-hidden">
        ...
        <div className="flex justify-between items-center relative z-10">
          ...
          <Badge className="bg-indigo-500 text-white border-none h-5 px-3 text-[9px] font-black uppercase tracking-widest leading-none">
            AI Activa
          </Badge>
        </div>
      </CardHeader>
          ...
          <div className="p-6 lg:col-span-2 space-y-6">
            <div className="space-y-4">
              ...
              <input 
                ...
                className="w-full accent-sky-500 bg-[#222] h-1.5 rounded-full appearance-none [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-sky-500"
              />
            ...
            <div className="space-y-4">
              ...
              <input 
                ...
                className="w-full accent-rose-500 bg-[#222] h-1.5 rounded-full appearance-none [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-rose-500"
              />
              <div className="flex justify-between text-[9px] text-muted-foreground/50 font-bold">
                <span>35.0°C</span>
                <span>37.0°C</span>
            ...
            <Button 
              className="w-full h-10 mt-4 bg-indigo-600 hover:bg-indigo-500 text-white text-[10px] uppercase font-bold tracking-widest"
            ...
            {!isSimulating ? (
              ...
              <div className="space-y-6 h-full flex flex-col">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-[#111] border border-rose-500/20 p-4 rounded-lg text-center space-y-1">
                  ...
                  <div className="bg-[#111] border border-emerald-500/20 p-4 rounded-lg text-center space-y-1 relative overflow-hidden">
                ...
                <div className="flex-1 min-h-[140px] mt-4 relative">
                  ...
                  {/* Legend */}
                  <div className="absolute bottom-0 right-0 flex items-center gap-3 bg-[#0a0a0a]/80 backdrop-blur-sm px-2 py-1 rounded text-[8px] uppercase tracking-widest font-bold">
                ...
                <div className="pt-4 border-t border-white/5 flex gap-3">
                  <Button variant="outline" className="flex-1 h-9 bg-transparent border-white/10 text-[9px] uppercase font-bold tracking-widest hover:bg-white/5" onClick={() => setIsSimulating(false)}>
                    Restablecer
                  </Button>
                  <Button className="flex-1 h-9 bg-emerald-600 hover:bg-emerald-500 text-[9px] uppercase font-bold tracking-widest text-white">
